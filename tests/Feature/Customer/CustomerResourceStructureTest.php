...
it('configures the customer form through the resource', function (): void {
    ...
    $componentNames = array_map(static function (mixed $component): string {
        if ($component instanceof TextInput || $component instanceof Select || $component instanceof Textarea || $component instanceof Toggle) {
            return $component->getName();
        }

        throw new RuntimeException('Expected customer form components to be supported Filament input types.');
