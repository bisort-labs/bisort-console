...
class LeadActionLogManager
{
    public function createNote(Lead $lead, string $title, ?string $body, int|string|null $actorId): void
    {
        $lead->actionLogs()->create([
    ...
    public function resolveForLead(Lead $lead, int|string|null $actionLogId): ActionLog
    {
