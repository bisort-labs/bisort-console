...
class DealActionLogManager
{
    public function createNote(Deal $deal, string $title, ?string $body, int|string|null $actorId): void
    {
    ...
    public function resolveForDeal(Deal $deal, int|string|null $actionLogId): ActionLog
    {
